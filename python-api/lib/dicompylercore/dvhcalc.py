...
from lib.dicompylercore import dvh
from lib.dicompylercore.config import skimage_available
import collections
from six import iteritems
import logging
logger = logging.getLogger('lib.dicompylercore.dvhcalc')
...
def get_dvh(structure,
    ...
    # Antigamente carregava o arquivo e gerava o objeto.
